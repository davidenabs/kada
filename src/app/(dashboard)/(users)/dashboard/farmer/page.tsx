...
const CooperativeDashboard: React.FC = () => {
  ...
  const handleOpenModal = () => {
    ...
    openModal({
      customSize: "654px",
      view: <>
        <main className="flex flex-col text-base font-medium leading-tight max-w-[517px] rounded-[40px]">
          <section className="flex overflow-hidden flex-col pb-8 w-full bg-white rounded-[40px] max-md:max-w-full">
            <header className="flex flex-col pt-6 pb-0.5 w-full max-md:max-w-full">
              ...
              <div className="flex flex-col px-10 w-full max-md:px-5 max-md:max-w-full">
                ...
                <form className="flex flex-col mt-11 max-md:mt-10 max-md:max-w-full">
                  ...
                  <SeasonSelector />
                  <ProductSelector /> */}
                  <button type="submit" className="overflow-hidden px-16 py-5 mt-8 font-bold text-white bg-green-800 rounded-[60px] max-md:px-5 max-md:max-w-full">
                    Create Farm
                  </button>
                </form>
              </div>
