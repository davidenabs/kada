        ...
        <div className="flex flex-col my-auto w-full leading-tight max-md:mt-10 self-stretch">
            ...
            <form className="flex flex-col items-start pl-8 mt-20 max-md:pl-5 max-md:mt-10">
                <div className="flex flex-col">
                    <h2 className="text-base font-bold text-teal-700">Data Enumerator</h2>
                ...
                <div className="flex flex-col mt-5">
                    ...
                    <Input id="firstName" placeholder="What is your company name" className='!py-3 !max-w-full w-[369px] h-[40px]' />
