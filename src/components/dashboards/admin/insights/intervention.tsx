...
const InterventionProgrammes: React.FC = () => {
  return (
    <div className="flex flex-col w-full max-md:mt-5 max-md:max-w-full">
      <div className="max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden flex-col grow items-start pt-7 pr-3 pb-4 pl-7 w-full leading-tight text-black bg-white rounded shadow-lg max-md:pl-5 max-md:mt-5">
          ...
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden flex-col grow items-start pt-7 pr-3 pb-4 pl-7 w-full leading-tight text-black whitespace-nowrap bg-white rounded shadow-lg max-md:pl-5 max-md:mt-5">
      ...
      <div className="flex flex-wrap gap-7 py-6 px-6 mt-6 max-w-full bg-white rounded shadow-lg w[578px] max-md:pl-5 max-md:mr-0.5">
